...
public class AnimaisActivity extends AppCompatActivity {
    ...
    private final String CATEGORY_NAME = "animal"; // <--- CONFIGURADO PARA ANIMAL
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animais); // Usando o layout 'activity_animais'
    ...
    private void startNewRound() {
        ...
        if (randomData != null && randomData.length >= 7) {
            // Assumimos que: [3]=PALAVRA, [4]=DICA1, [5]=DICA2, [6]=DICA3
